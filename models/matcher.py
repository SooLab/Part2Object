...
class HungarianMatcher(nn.Module):
    ...
    @torch.no_grad()
    def memory_efficient_forward(self, outputs, targets, mask_type, score_outputs=None):
        ...
        for b in range(bs):
            ...
            tgt_ids = targets[b]["labels" + mask_type[-7:]].clone()
    ...
    @torch.no_grad()
    def forward(self, outputs, targets, mask_type, score_outputs=None):
        ...
        """
        return self.memory_efficient_forward(outputs, targets, mask_type, score_outputs=score_outputs)
