...
def find_corresp_by_mask(image_path1, image_path2, extractor, num_pairs = 100, load_size = 224):
    device = 'cuda'
    layer = 9
    facet = 'key'
    thresh = 0.05
...
def find_correspondences(image_path1: str, image_path2: str, num_pairs: int = 100, load_size: int = 224, layer: int = 9,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_pairs', default=100, type=int, help='Final number of correspondences.')
    ...
    with torch.no_grad():
        ...
        for pair_dir in tqdm(pair_dirs):
            ...
            points1, points2, image1_pil, image2_pil = find_correspondences(curr_images[0], curr_images[1],
                                                                            ...
                                                                            args.facet, args.bin, args.thresh, stride=args.stride,)
